...
VLLM_SERVER_GPUS="0,1,2,3" # comma-separated list of GPU ids to use for vLLM server, e.g., "0,1,2,3"

# dataset parameters
DATASET_NAME="quality" # choices: "quality", "mhrag", "squad"
DATASET_IN="QuALITY"
DATASET_OUT="data/synthetic_quality/quality.json" # the json path to save the generated data
...
INSTRUCT_MODEL=1 # choices: 0 (base model), 1 (instruct model)
USE_API=0 #choices: 0 (vLLM), 1 (API)
